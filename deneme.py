...
<style>
    ...
    /* Customizing Google Search to fit the theme */
    .gsc-control-cse {
    ...
    .gsc-search-button-v2 {
        background-color: #BC9353 !important;
        border-color: #BC9353 !important;
    }
</style>
"""

# Start building index.html with correct layout
# REPLACE 'YOUR_CX_ID' with your actual Search Engine ID from Google
html = f"""
<!DOCTYPE html>
<html lang='en'>
<head>
...
<body class='p-6'>
    <div class='max-w-3xl mx-auto'>
        ...
        <div class="mb-10">
            <h2 class="text-sm mb-2" style="color: #8D8273;">Detaylı Arama (Deep Search):</h2>
            <div class="gcse-search"></div>
        </div>

        <hr>

        <h2 class="text-2xl font-bold mb-4">Hızlı Liste (Quick Filter):</h2>
...
<body class='p-6'>
    <div class='max-w-3xl mx-auto'>
        ...
        <footer class='pb-12 text-center'>
            <p style='color: #8D8273;'>Toygar Par - The Salsabil Project</p>
        </footer>
    </div>
</body>
</html>
...
print("✅ Surahs generated with Google Search and Quick Filter! Open index.html to view it.")